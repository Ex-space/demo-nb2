<template>
  <div>
    <div ref="app" class="app-container" id="app" v-if="Loadingflag">
      <router-view :key="key"></router-view>
      <transition name="fade">
        <div class="slidebar" ref="slidebar" v-show="toggleVisible">
          <div @click.stop="changeVisible" class="toggle">
            <div class="iconfont icon-a-24_nor"></div>
          </div>
          <transition name="slide-fade">
            <label class="switch" @click.stop="" @change="changemode" v-show="switchVisible">
              <input type="checkbox" checked="checked">
              <span class="slider"></span>
            </label>
          </transition>
          <Back-top class="backtop" :bottom="200">
...
export default {
  ...
  async created() {
    ...
    this.$store.state.me.name = reshome.data.blogConfig.website_author
    this.$store.state.me.portrait = reshome.data.blogConfig.website_avatar
  },
  methods: {
    handleScroll() {
    ...
    changemode() {
      if (this.flag) {
        this.$refs.app.style.backgroundColor = '#333'
      } else {
        this.$refs.app.style.backgroundColor = ''
      }
      this.flag = !this.flag
    },
    changeVisible() {
